import { Response as Res, Request as Req, Errback, Send, Application, CookieOptions, MediaType} from 'express'
...
export class Params{[prop: string]:any}
export class Query{[prop: string]:any}
...
export abstract class Response extends ServerResponse implements Res{
   ...
   */
  abstract sendStatus(code: number): Response
...
export abstract class Request extends IncomingMessage implements Req{
  [prop: string]:any
  /**
   ...
   */
  abstract range(size: number): RequestRanges|null|-1|-2;
